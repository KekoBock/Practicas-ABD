...
public class UserJdbcRepository implements UserRepository {
    ...
    private void insecureConnection(String srv, int port, String sid, String usr, String password){
        try {
            ...
            connection = java.sql.DriverManager.getConnection("jdbc:oracle:thin:@" + srv + ":" + port + "/" + sid, usr, password);
    ...
    public UserJdbcRepository(JdbcTemplate jdbcTemplate) {
        ...
        // insecureConnection("//147.96.85.52", 1521, "ABDs", "", "");
    }

    @Override
    public void createInsecure(User user) {
        String sql = "INSERT INTO users (id, username, password) VALUES" +
                "(seq_users_id.nextval, '" + user.getUsername() + "', '" +
