 ...
 * 
 * @author Ivan Martinez Ortiz , Héctor Gómez Gauchía
 */
public class JdbcTest01 {
    private static final String URL = "jdbc:oracle:thin:@147.96.85.52:1521/ABDs";
//     private static final String URL = "jdbc:oracle:thin:@tania.fdi.ucm.es:1521/ABDs";
    ...
    private Connection getConnectionFromDataSource() throws SQLException {
        OracleDataSource ds = new OracleDataSource(); // A DataSource object is a factory for Connection objects
        ds.setURL(URL);
        ds.setUser(USER);
